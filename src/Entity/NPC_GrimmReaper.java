...
public class NPC_GrimmReaper extends Entity {
    ...
    public void setDialogue() {
        ...
        dialogues[13] = "The thing is, I have been doing this for a very, very, very long time and have gotten really " +
                "tired.\nI haven't even been able to attend my knitting club in decennia!\nReading books, something I " +
                "used to love, has become a chore...\nAnd let's nog even start about my poor, poor Ceberus... " +
                "Sitting at home... Alone... All day!:(";
        dialogues[14] = "Even getting dressed out of my pyjama's in the morning is difficult!";
        dialogues[15] = "...";
        ...
        dialogues[18] = "But I want it to be someone who is loving and caring, some characteristics I think you might\n" +
                "posses:)";
        dialogues[19] = "To test my new successor I made this island, containing 3 dungeons to see if " +
